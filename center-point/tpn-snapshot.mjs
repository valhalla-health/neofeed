...
export function buildTpn(p, D, effectiveFrom, effectiveTo) {
 ...
 mgKg:f(p.mgPerKg,3),mgMgKg:f(p.mgPerKg*D.MG_MG_PER_MEQ,1),mgBag:f(p.mgPerKg*factor,2),mgStrength:z(Number(p.mgStrength),0),mgMl:f(s.mg,2),caKg:f(p.caPerKg,3),caBag:f(p.caPerKg*factor,0),caMl:f(s.ca),
