...
function NumField({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, label, unit && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("wbr", null), /* @__PURE__ */ React.createElement("span", { className: "unit" }, "(", unit, ")"))), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
...
ยืนยันการสั่งหรือไม่? — แพทย์ยืนยันคำสั่งโดยระบุเหตุผลทางคลินิก (จะพิมพ์ลงใบสั่ง TPN · ห้ามใส่ชื่อหรือ HN):`,
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, conflict && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    alignItems: "center",
    gap: 6
  } }, "💉 TPN Aqueous Pump"), /* @__PURE__ */ React.createElement("div", { style: { padding: "12px 14px", display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 28px minmax(0,1fr)", gap: 8, alignItems: "start" } }, /* @__PURE__ */ React.createElement(
    NumField,
    {
      label: "Volume",
      unit: "mL/day",
  ...
  } }, fmt(calc.gir, 1), /* @__PURE__ */ React.createElement("wbr", null), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--ink-3)", marginLeft: 4, fontWeight: 400 } }, "mg/kg/min")), /* @__PURE__ */ React.createElement(Meter, { value: calc.gir || 0, target: tGir, max: 16, optimal: [8, 10], statusAt: girStatusAt }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-3)", marginTop: 2 } }, "target 8–10 · max 12"))), /* @__PURE__ */ React.createElement("div", { className: "s2-aa-row", style: {
    display: "grid",
...
function StepBody({ open, children }) {
  return /* @__PURE__ */ React.createElement("div", { className: `accordion-body${open ? " open" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "accordion-inner" }, children));
}
function TwoCol({ children }) {
  return /* @__PURE__ */ React.createElement("div", { className: "two-col", style: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) 280px", gap: 14 } }, children);
}
