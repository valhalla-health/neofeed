...
บันทึกต่อได้เมื่อระบุเหตุผลทางคลินิก (จะพิมพ์ลงใบสั่ง TPN · ห้ามใส่ชื่อหรือ HN):`,
  ...
  } }, "in bag: ", fmt(calc.kMeqPerL, 0), " mEq/L (max ", D.MAX_K_MEQ_PER_L, ")"), /* @__PURE__ */ React.createElement(Tile, { label: "Magnesium", value: mgPerKg, unit: " mEq/kg/d", target: tMg, status: sMg, decimals: 2, max: 1 }), mgPerKg > 0 && /* @__PURE__ */ React.createElement(
    "div",
    {
      className: "mg-mgkg",
