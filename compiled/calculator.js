...
ยืนยันการสั่งหรือไม่? — แพทย์ยืนยันคำสั่งโดยระบุเหตุผลทางคลินิก (จะพิมพ์ลงใบสั่ง TPN · ห้ามใส่ชื่อหรือ HN):`,
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, conflict && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    ["P", calc.enFeedKg.p, 0]
  ].map(([lab, v, d]) => /* @__PURE__ */ React.createElement("span", { key: lab, style: { whiteSpace: "nowrap" } }, lab, " ", /* @__PURE__ */ React.createElement("span", { className: "num", style: { fontWeight: 600, color: isMEN ? "var(--ink-3)" : "var(--ink)" } }, fmt(v, d))))))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement(Tile, { label: "EN volume", value: calc.enVolPerKg, unit: " mL/kg/d", target: [100, 200], status: calc.enVolPerKg >= 100 ? "ok" : calc.enVolPerKg > 0 ? "warn" : "ok", decimals: 0, max: 210 }), (() => {
...
Copy order ต่อไปหรือไม่?`)) return;
    const lines = [
      ...
      calc.overfill > 1.001 ? `  PREPARE:     ${fmt(calc.preparedVol, 1)} mL/day (+${fmt(deadVol_mL, 1)} mL ปริมาตรคาสาย) · Factor ${fmt(calc.factor, 3)} = ${fmt(calc.wtKg, 3)} kg × ${fmt(calc.overfill, 3)}` : `  PREPARE:     ${fmt(calc.preparedVol, 1)} mL/day (no overfill)`,
...
function KcalBar({ cho, pro, fat }) {
  return /* @__PURE__ */ React.createElement("div", { style: { height: 22, borderRadius: 6, overflow: "hidden", display: "flex", border: "1px solid var(--line)" } }, /* @__PURE__ */ React.createElement("div", { style: { width: `${cho}%`, background: "oklch(73.6% 0.082 80)" } }), /* @__PURE__ */ React.createElement("div", { style: { width: `${pro}%`, background: "oklch(55% 0.13 155)" } }), /* @__PURE__ */ React.createElement("div", { style: { width: `${fat}%`, background: "oklch(60% 0.11 25)" } }));
}
