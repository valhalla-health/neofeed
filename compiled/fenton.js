...
function FentonChart({ patient, entries, currentDol, onUpdate }) {
  ...
  const PERCENTILES = [
    ...
    { idx: 3, label: "50th", color: "oklch(38.5% 0.047 170)", w: 2, dash: "" },
...
function GrowthVelocity({ points, metric = "weight", patient, entries }) {
  if (metric === "weight") {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 22, fontWeight: 500, color } }, D_F.displayNum(gv.vel, 1), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--ink-3)", marginLeft: 4 } }, "g/kg/d")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: "var(--ink-3)", marginTop: 2 } }, "Target ≥ 15 g/kg/d · ", gv.days, " วัน"));
  }
  if (points.length < 2) {
    return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--ink-3)" } }, "Need ≥ 2 measurements");
  }
